...
// @route  GET /api/v1/bootcamps/:bootcampIds/courses
// @access Public
...
exports.addCourse = asyncHandler(async(req, res, next) => {
    ...
    if (bootcamp.user.toString() !== req.user.id && req.user.role !== 'admin') {
        return next(new ErrorResponse(`User ${req.user.id} is not authorized to add course to this bootcamp ${bootcamp._id}`, 401));
    }
